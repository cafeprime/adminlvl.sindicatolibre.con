...
return new class extends Migration
{
    ...
    {
        Schema::create('registros_mod', function (Blueprint $table) {
            $table->increments('IDMODIFICADO');
            ...
            $table->primary(['IDMODIFICADO', 'IDREGISTRO', 'DNI', 'DNI_LETRA', 'PROVINCIA', 'EMAIL', 'ADMINREG']);
        });
    }
    ...
    {
        Schema::dropIfExists('registros_mod');
    }
};
